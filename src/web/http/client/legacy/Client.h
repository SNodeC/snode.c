...
#include "net/in/stream/legacy/SocketClient.h"  // IWYU pragma: export
...
namespace web::http::client::legacy {
    ...
    class Client6 : public web::http::client::Client<net::in6::stream::legacy::SocketClient, Request, Response> {
