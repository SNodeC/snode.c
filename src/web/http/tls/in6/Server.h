...
namespace web::http::tls::in6 {
    ...
    protected:
        using SocketServer = net::in6::stream::tls::SocketServer<web::http::server::SocketContextFactory<Request, Response>>;
    ...
    public:
        ...
        void
        listen(const std::string& ipOrHostname, uint16_t port, const std::function<void(const net::in6::stream::Socket&, int)>& onError) {
