...
#ifndef WEB_HTTP_TLS_UN_CLIENT_H
#define WEB_HTTP_TLS_UN_CLIENT_H
...
namespace web::http::tls::un {
    ...
    protected:
        using SocketClient = net::un::stream::tls::SocketClient<web::http::client::SocketContextFactory<Request, Response>>;

    public:
        using web::http::client::Client<net::un::stream::tls::SocketClient, Request, Response>::connect;
    };

} // namespace web::http::tls::un

#endif // WEB_HTTP_TLS_UN_CLIENT_H
