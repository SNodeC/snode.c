...
namespace iot::mqtt::client::packets {
    ...
    Pubrel::Pubrel(uint32_t remainingLength, uint8_t flags)
        : iot::mqtt::client::ControlPacketDeserializer(remainingLength, flags, MQTT_PUBREL_FLAGS) {
        this->flags = flags;
    }
    ...
    void Pubrel::propagateEvent(iot::mqtt::client::SocketContext* socketContext) {
