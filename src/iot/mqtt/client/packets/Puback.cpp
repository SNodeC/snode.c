...
namespace iot::mqtt::client::packets {
    ...
    Puback::Puback(uint32_t remainingLength, uint8_t flags)
        : iot::mqtt::client::ControlPacketDeserializer(remainingLength, flags, MQTT_PUBACK_FLAGS) {
        this->flags = flags;
    }
    ...
    void Puback::propagateEvent(iot::mqtt::client::SocketContext* socketContext) {
