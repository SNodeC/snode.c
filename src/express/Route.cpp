...
#define DEFINE_ROUTE_REQUESTMETHOD(METHOD, HTTP_METHOD)                                                                                    \
    Route& Route::METHOD(const std::function<void(Request & req, Response & res, Next & next)>& lambda) const {                            \
    ...
    Route& Route::METHOD(const std::function<void(Request & req, Response & res)>& lambda) const {                                         \
        return *(dispatcher->next = std::make_shared<Route>(                                                                               \
