...
#include "net/ip/stream/ClientSocket.h"        // IWYU pragma: export
...
namespace net::ip::stream::tls {
    ...
    using SocketClient = core::socket::stream::tls::SocketClient<net::ip::stream::ClientSocket, SocketContextFactoryT>;
