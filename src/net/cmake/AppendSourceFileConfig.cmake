function(append_source_file_config source_file CONFIG_OPTION description default_value)
    ...
    set_property(
      SOURCE ${source_file}
      APPEND PROPERTY COMPILE_DEFINITIONS ${CONFIG_OPTION}=${CACHE_${CONFIG_OPTION}}
    )

    message(STATUS "Appending compile definition to '${source_file}': " '${CONFIG_OPTION}=${CACHE_${CONFIG_OPTION}}')
