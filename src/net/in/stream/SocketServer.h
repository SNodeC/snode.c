...
namespace net::in::stream {
    ...
    class SocketServer : public net::LogicalSocketServer<net::in::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::LogicalSocketServer<net::in::stream::PhysicalServerSocket, ConfigT>;
