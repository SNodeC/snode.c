...
namespace net::in::stream {
    ...
    class SocketServer : public net::stream::SocketServer<net::in::stream::ServerSocket, ConfigT> {
    private:
        using Super = net::stream::SocketServer<net::in::stream::ServerSocket, ConfigT>;
