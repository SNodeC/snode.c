...
namespace net::in::stream {
    ...
    class SocketClient : public net::stream::SocketClient<net::in::stream::PhysicalClientSocket, ConfigT> {
    private:
        using Super = net::stream::SocketClient<net::in::stream::PhysicalClientSocket, ConfigT>;
