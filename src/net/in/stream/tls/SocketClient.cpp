...
template class core::socket::stream::tls::SocketConnector<net::in::stream::PhysicalClientSocket,
                                                          net::in::stream::tls::config::ConfigSocketClient>;
template class core::socket::stream::tls::SocketConnection<net::in::stream::PhysicalClientSocket>;
...
template class core::socket::stream::SocketConnectionFactory<
    ...
    net::in::stream::tls::config::ConfigSocketClient,
    core::socket::stream::tls::SocketConnection<net::in::stream::PhysicalClientSocket>>;
template class core::socket::stream::tls::SocketReader<net::in::stream::PhysicalClientSocket>;
template class core::socket::stream::SocketReader<net::in::stream::PhysicalClientSocket>;
template class core::socket::stream::tls::SocketWriter<net::in::stream::PhysicalClientSocket>;
