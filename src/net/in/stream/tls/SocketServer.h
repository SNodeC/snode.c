...
namespace net::in::stream::tls {
    ...
    using SocketServer = net::in::stream::
        SocketServer<core::socket::stream::tls::SocketAcceptor, net::in::stream::tls::config::ConfigSocketServer, SocketContextFactoryT>;

} // namespace net::in::stream::tls

extern template class core::socket::Socket<net::in::stream::tls::config::ConfigSocketServer>;
extern template class core::socket::stream::tls::SocketAcceptor<net::in::stream::PhysicalSocketServer,
                                                                net::in::stream::tls::config::ConfigSocketServer>;
extern template class core::socket::stream::tls::SocketConnection<net::in::stream::PhysicalSocketServer>;
extern template class core::socket::stream::SocketConnectionT<net::in::stream::PhysicalSocketServer,
