...
namespace net::in::stream::tls::config {
    ...
    ConfigSocketClient::ConfigSocketClient(const std::string& name)
        : net::config::socket::stream::tls::ConfigSocketClient<net::in::stream::config::ConfigSocketClient>(name) {
    }
...
template class net::config::socket::stream::tls::ConfigSocketClient<net::in::stream::config::ConfigSocketClient>;
