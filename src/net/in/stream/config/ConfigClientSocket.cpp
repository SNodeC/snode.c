...
namespace net::in::stream::config {
    ...
    ConfigClientSocket::ConfigClientSocket(const std::string& name)
        ...
        , net::in::config::ConfigAddress<net::config::ConfigRemote>(baseSc)
        , net::in::config::ConfigAddress<net::config::ConfigLocal>(baseSc)
        , net::config::ConfigConnection(baseSc) {
        net::in::config::ConfigAddress<net::config::ConfigRemote>::required();
    }
