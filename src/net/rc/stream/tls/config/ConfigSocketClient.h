...
namespace net::rc::stream::tls::config {
    ...
    class ConfigSocketClient final
        : public net::config::socket::stream::tls::ConfigSocketClient<net::rc::stream::config::ConfigSocketClient> {
    public:
...
extern template class net::config::socket::stream::tls::ConfigSocketClient<net::rc::stream::config::ConfigSocketClient>;
