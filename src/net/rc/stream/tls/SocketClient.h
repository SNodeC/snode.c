...
extern template class core::socket::stream::tls::SocketConnector<net::rc::stream::PhysicalSocketClient,
                                                                 net::rc::stream::tls::config::ConfigSocketClient>;
extern template class core::socket::stream::tls::SocketConnection<net::rc::stream::PhysicalSocketClient>;
