...
namespace net::rc::stream {
    ...
    class SocketServer : public net::LogicalSocketServer<net::rc::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::LogicalSocketServer<net::rc::stream::PhysicalServerSocket, ConfigT>;
