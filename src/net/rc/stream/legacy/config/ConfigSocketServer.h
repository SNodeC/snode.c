...
namespace net::rc::stream::legacy::config {
    ...
    class ConfigSocketServer final
        : public net::config::socket::stream::legacy::ConfigSocketServer<net::rc::stream::config::ConfigSocketServer> {
    public:
...
extern template class net::config::socket::stream::legacy::ConfigSocketServer<net::rc::stream::config::ConfigSocketServer>;
