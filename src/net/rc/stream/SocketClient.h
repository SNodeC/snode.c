...
namespace net::rc::stream {
    ...
    class SocketClient : public net::stream::SocketClient<net::rc::stream::PhysicalClientSocket, ConfigT> {
    private:
        using Super = net::stream::SocketClient<net::rc::stream::PhysicalClientSocket, ConfigT>;
