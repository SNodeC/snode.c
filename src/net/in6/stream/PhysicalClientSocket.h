...
namespace net::in6::stream {
    ...
    class PhysicalClientSocket : public net::stream::PhysicalClientSocket<net::in6::stream::PhysicalSocket> {
    private:
        using Super = net::stream::PhysicalClientSocket<net::in6::stream::PhysicalSocket>;
...
extern template class net::stream::PhysicalClientSocket<net::in6::stream::PhysicalSocket>;
