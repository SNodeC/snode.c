...
namespace net::in6::stream {
    ...
    class SocketClient : public net::LogicalClientSocket<net::in6::stream::PhysicalClientSocket, ConfigT> {
    private:
        using Super = net::LogicalClientSocket<net::in6::stream::PhysicalClientSocket, ConfigT>;
