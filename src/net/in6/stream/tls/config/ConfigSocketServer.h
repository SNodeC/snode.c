...
namespace net::in6::stream::tls::config {
    ...
    class ConfigSocketServer final
        : public net::config::socket::stream::tls::ConfigSocketServer<net::in6::stream::config::ConfigSocketServer> {
    public:
...
extern template class net::config::socket::stream::tls::ConfigSocketServer<net::in6::stream::config::ConfigSocketServer>;
