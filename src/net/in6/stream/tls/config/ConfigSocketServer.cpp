...
namespace net::in6::stream::tls::config {
    ...
    ConfigSocketServer::ConfigSocketServer(const std::string& name)
        : net::config::socket::stream::tls::ConfigSocketServer<net::in6::stream::config::ConfigSocketServer>(name) {
    }
...
template class net::config::socket::stream::tls::ConfigSocketServer<net::in6::stream::config::ConfigSocketServer>;
