...
namespace net::in6::stream::tls::config {
    ...
    class ConfigSocketClient final : public net::config::stream::tls::ConfigSocketClient<net::in6::stream::config::ConfigSocketClient> {
    public:
...
extern template class net::config::stream::tls::ConfigSocketClient<net::in6::stream::config::ConfigSocketClient>;
