...
namespace net::in6::stream::tls::config {
    ...
    class ConfigSocketClient final
        : public net::config::socket::stream::tls::ConfigSocketClient<net::in6::stream::config::ConfigSocketClient> {
    public:
...
extern template class net::config::socket::stream::tls::ConfigSocketClient<net::in6::stream::config::ConfigSocketClient>;
