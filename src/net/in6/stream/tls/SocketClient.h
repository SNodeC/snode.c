...
namespace net::in6::stream::tls {
    ...
    using SocketClient = net::in6::stream::
...
extern template class core::socket::stream::tls::SocketConnector<net::in6::stream::PhysicalSocketClient,
                                                                 net::in6::stream::tls::config::ConfigSocketClient>;
extern template class core::socket::stream::tls::SocketConnection<net::in6::stream::PhysicalSocketClient>;
extern template class core::socket::stream::SocketConnectionT<net::in6::stream::PhysicalSocketClient,
