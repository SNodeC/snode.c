...
template class core::socket::stream::tls::SocketConnector<net::in6::stream::PhysicalSocketClient,
                                                          net::in6::stream::tls::config::ConfigSocketClient>;
template class core::socket::stream::tls::SocketConnection<net::in6::stream::PhysicalSocketClient>;
template class core::socket::stream::SocketConnectionT<net::in6::stream::PhysicalSocketClient,
