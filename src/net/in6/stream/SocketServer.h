...
namespace net::in6::stream {
    ...
    class SocketServer : public net::LogicalServerSocket<net::in6::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::LogicalServerSocket<net::in6::stream::PhysicalServerSocket, ConfigT>;
