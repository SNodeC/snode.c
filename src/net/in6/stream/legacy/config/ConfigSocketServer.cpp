...
namespace net::in6::stream::legacy::config {
    ...
    ConfigSocketServer::ConfigSocketServer(const std::string& name)
        : net::config::stream::legacy::ConfigSocketServer<net::in6::stream::config::ConfigSocketServer>(name) {
    }
...
template class net::config::stream::legacy::ConfigSocketServer<net::in6::stream::config::ConfigSocketServer>;
