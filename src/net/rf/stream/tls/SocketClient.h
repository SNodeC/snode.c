...
#include "net/rf/stream/tls/config/ConfigSocketClient.h" // IWYU pragma: export
...
namespace net::rf::stream::tls {
    ...
    using SocketClient = core::socket::stream::tls::
        SocketClient<net::rf::stream::ClientSocket, net::rf::stream::tls::config::ConfigSocketClient, SocketContextFactoryT>;
