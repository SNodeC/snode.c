...
namespace net::l2::stream {
    ...
    class SocketServer : public net::LogicalSocketServer<net::l2::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::LogicalSocketServer<net::l2::stream::PhysicalServerSocket, ConfigT>;
