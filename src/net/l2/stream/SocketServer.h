...
namespace net::l2::stream {
    ...
    class SocketServer : public net::LogicalServerSocket<net::l2::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::LogicalServerSocket<net::l2::stream::PhysicalServerSocket, ConfigT>;
