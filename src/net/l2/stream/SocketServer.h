...
namespace net::l2::stream {
    ...
    class SocketServer : public net::stream::SocketServer<net::l2::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::stream::SocketServer<net::l2::stream::PhysicalServerSocket, ConfigT>;
