...
#include "net/l2/stream/PhysicalSocketClient.h" // IWYU pragma: export
...
namespace net::l2::stream {
    ...
    class SocketClient
        : public core::socket::stream::SocketClient<SocketConnectorT<net::l2::stream::PhysicalSocketClient, ConfigSocketClientT>,
                                                    SocketContextFactoryT> {
    private:
        using Super = core::socket::stream::SocketClient<SocketConnectorT<net::l2::stream::PhysicalSocketClient, ConfigSocketClientT>,
                                                         SocketContextFactoryT>;
    ...
    public:
        ...
        void connect(const std::string& btAddress, uint16_t psm, const std::function<void(const core::ProgressLog&)>& onError) {
