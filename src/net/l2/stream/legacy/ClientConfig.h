...
#ifndef NET_L2_STREAM_LEGACY_CLIENTCONFIG_H
#define NET_L2_STREAM_LEGACY_CLIENTCONFIG_H

#include "net/config/ConfigLegacy.h"
#include "net/l2/stream/ClientConfig.h"
...
#endif // NET_L2_STREAM_LEGACY_CLIENTCONFIG_H
