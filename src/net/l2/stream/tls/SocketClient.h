...
extern template class core::socket::stream::tls::SocketConnector<net::l2::stream::PhysicalSocketClient,
                                                                 net::l2::stream::tls::config::ConfigSocketClient>;
extern template class core::socket::stream::tls::SocketConnection<net::l2::stream::PhysicalSocketClient>;
