...
extern template class core::socket::stream::tls::SocketAcceptor<net::l2::stream::PhysicalSocketServer,
                                                                net::l2::stream::tls::config::ConfigSocketServer>;
extern template class core::socket::stream::tls::SocketConnection<net::l2::stream::PhysicalSocketServer>;
