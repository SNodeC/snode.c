...
namespace net::l2::stream::tls::config {
    ...
    ConfigSocketClient::ConfigSocketClient(const std::string& name)
        : net::config::stream::tls::ConfigSocketClient<net::l2::stream::config::ConfigSocketClient>(name) {
    }
...
template class net::config::stream::tls::ConfigSocketClient<net::l2::stream::config::ConfigSocketClient>;
