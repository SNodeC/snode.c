...
namespace net::un::stream {
    ...
    class SocketClient : public net::LogicalClientSocket<net::un::stream::PhysicalClientSocket, ConfigT> {
    private:
        using Super = net::LogicalClientSocket<net::un::stream::PhysicalClientSocket, ConfigT>;
