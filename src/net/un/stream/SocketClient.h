...
namespace net::un::stream {
    ...
    class SocketClient : public net::LogicalSocketClient<net::un::stream::PhysicalClientSocket, ConfigT> {
    private:
        using Super = net::LogicalSocketClient<net::un::stream::PhysicalClientSocket, ConfigT>;
