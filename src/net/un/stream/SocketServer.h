...
namespace net::un::stream {
    ...
    class SocketServer : public net::LogicalSocketServer<net::un::stream::PhysicalServerSocket, ConfigT> {
    private:
        using Super = net::LogicalSocketServer<net::un::stream::PhysicalServerSocket, ConfigT>;
