...
namespace net::un::stream::legacy {
    ...
    using SocketServer =
        core::socket::stream::legacy::SocketServer<net::un::stream::SocketServer<net::un::stream::legacy::config::ConfigSocketServer>,
                                                   SocketContextFactoryT>;

} // namespace net::un::stream::legacy

extern template class net::un::stream::SocketServer<net::un::stream::legacy::config::ConfigSocketServer>;
extern template class core::socket::stream::LogicalSocketServer<net::un::stream::PhysicalServerSocket, net::un::stream::legacy::config::ConfigSocketServer>;
