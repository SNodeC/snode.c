...
namespace net::un::stream {
    ...
    class PhysicalSocketClient : public net::un::stream::PhysicalSocket<net::phy::stream::PhysicalSocketClient> {
    private:
        using Super = net::un::stream::PhysicalSocket<net::phy::stream::PhysicalSocketClient>;
