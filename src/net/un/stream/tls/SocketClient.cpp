...
#include "net/un/stream/tls/config/ConfigSocketClient.h" // IWYU pragma: keep
...
template class net::stream::ClientSocket<net::un::stream::tls::config::ConfigSocketClient, net::un::stream::Socket>;
