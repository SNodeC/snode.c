...
extern template class net::LogicalSocketClient<net::un::stream::PhysicalClientSocket, net::un::stream::tls::config::ConfigSocketClient>;
extern template class net::LogicalSocket<net::un::stream::tls::config::ConfigSocketClient>;
