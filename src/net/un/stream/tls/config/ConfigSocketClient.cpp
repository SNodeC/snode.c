...
namespace net::un::stream::tls::config {
    ...
    ConfigSocketClient::ConfigSocketClient(const std::string& name)
        : net::config::stream::tls::ConfigSocketClient<net::un::stream::config::ConfigSocketClient>(name) {
    }
...
template class net::config::stream::tls::ConfigSocketClient<net::un::stream::config::ConfigSocketClient>;
