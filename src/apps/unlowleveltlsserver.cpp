...
#include "net/un/stream/tls/SocketServer.h"          // for SocketS...
...
using SocketServer = net::un::stream::tls::SocketServer<SimpleSocketProtocolFactory>;
...
int main(int argc, char* argv[]) {
    ...
    server.listen("/tmp/testme",
                  5,
                  [](int errnum) -> void { // titan
                      if (errnum != 0) {
