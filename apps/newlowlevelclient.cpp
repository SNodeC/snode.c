...
#include "socket/sock_stream/legacy/SocketClientNew.h"
#include "socket/sock_stream/tls/SocketClientNew.h"
...
legacy::SocketClientNew<net::socket::ipv4::tcp::Socket> getLegacyClient() {
    legacy::SocketClientNew<net::socket::ipv4::tcp::Socket> legacyClient(
        [](legacy::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection) -> void {
            socketConnection->setContext<http::ResponseParser*>(getResponseParser());
        },
        []([[maybe_unused]] legacy::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection)
            -> void { // onDestruct
        },
        [](legacy::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection) -> void { // onConnect
            VLOG(0) << "OnConnect";
        ...
        [](legacy::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection) -> void { // onDisconnect
            VLOG(0) << "OnDisconnect";
            VLOG(0) << "\tServer: " + socketConnection->getRemoteAddress().host() + "(" + socketConnection->getRemoteAddress().ip() +
                           "):" + std::to_string(socketConnection->getRemoteAddress().port());
            VLOG(0) << "\tClient: " + socketConnection->getLocalAddress().host() + "(" + socketConnection->getLocalAddress().ip() +
        ...
        [](legacy::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection,
           const char* junk,
...
tls::SocketClientNew<net::socket::ipv4::tcp::Socket> getTlsClient() {
    tls::SocketClientNew<net::socket::ipv4::tcp::Socket> tlsClient(
        [](tls::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection) -> void { // onConstruct
            socketConnection->setContext<http::ResponseParser*>(getResponseParser());
        },
        []([[maybe_unused]] tls::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection)
            -> void { // onDestruct
        },
        [](tls::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection) -> void { // onConnect
            VLOG(0) << "OnConnect";
            socketConnection->enqueue("GET /index.html HTTP/1.1\r\n\r\n"); // Connection:keep-alive\r\n\r\n");
        ...
        [](tls::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection) -> void { // onDisconnect
            VLOG(0) << "OnDisconnect";
            VLOG(0) << "\tClient: " + socketConnection->getLocalAddress().host() + "(" + socketConnection->getLocalAddress().ip() +
                           "):" + std::to_string(socketConnection->getLocalAddress().port());
            VLOG(0) << "\tServer: " + socketConnection->getRemoteAddress().host() + "(" + socketConnection->getRemoteAddress().ip() +
        ...
        [](tls::SocketClientNew<net::socket::ipv4::tcp::Socket>::SocketConnection* socketConnection,
           const char* junk,
           ssize_t junkSize) -> void { // onRead
            VLOG(0) << "OnRead";
        ...
        []([[maybe_unused]] tls::SocketConnection<net::socket::ipv4::tcp::Socket>* socketConnection,
           int errnum) -> void { // onReadError
...
int main(int argc, char* argv[]) {
    ...
    { /*
         legacy::SocketClientNew legacyClient = getLegacyClient();
 ...
 */
        tls::SocketClientNew tlsClient = getTlsClient();
        tlsClient.connect({{"host", "localhost"}, {"port", 8088}}, [](int err) -> void {
            if (err) {
                PLOG(ERROR) << "Connect: " << std::to_string(err);
            } else {
