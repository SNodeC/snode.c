...
#     target_link_libraries(<target> SNODEC_EXPRESS_LIBRARIES)
# to your CMakeLists.txt file
#
#
# In case you have installed snode.c in an non-system-standard location
# run cmake with option "-DSNODEC_ROOT_DIR=<path_to_snode.c_installation>
# or set the environment variable SNODEC_ROOT_DIR to point to your
# <path_to_snode.c_installation>
#

include(${CMAKE_ROOT}/${CMAKE_LIST_DIR}/Modules/FindPackageHandleStandardArgs.cmake)
...
if (NOT SNODEC_FOUND)
    ...
    find_library (SNODEC_LOGGER_LIBRARY logger
        HINTS ${SNODEC_LOGGER_ROOT_DIR}/lib
    )

    ########### NET
    find_path(SNODEC_NET_H
        NAMES EventLoop.h
    ...
    find_library (SNODEC_NET_LIBRARY net
        HINTS ${SNODEC_NET_ROOT_DIR}/lib
    )

    ########### HTTP
    find_path(SNODEC_HTTP_H
        NAMES http_utils.h
    ...
    find_library (SNODEC_HTTP_LIBRARY http
        HINTS ${SNODEC_HTTP_ROOT_DIR}/lib
    )

    ########### EXPRESS
    find_path(SNODEC_EXPRESS_H
        NAMES WebApp.h
    ...
    find_library (SNODEC_EXPRESS_LIBRARY express
        HINTS ${SNODEC_EXPRESS_ROOT_DIR}/lib
    )

    ########### UTILS
    find_path(SNODEC_UTILS_H
    ...
    find_package_handle_standard_args(SnodeC
        REQUIRED_VARS
            SNODEC_NET_LIBRARY SNODEC_NET_INCLUDE
            SNODEC_LOGGER_INCLUDE SNODEC_LOGGER_LIBRARY
            SNODEC_HTTP_INCLUDE SNODEC_HTTP_LIBRARY
            SNODEC_EXPRESS_INCLUDE SNODEC_EXPRESS_LIBRARY
            SNODEC_UTILS_H
        FAIL_MESSAGE "SnodeC not found: Define SNODEC_ROOT_DIR or set the environment variable SNODEC_ROOT_DIR to point to the directory where snode.c is installed." )
...
if (SNODEC_FOUND)
    ...
    set(SNODEC_EXPRESS_LIBRARIES ${SNODEC_HTTP_LIBRARIES} ${SNODEC_EXPRESS_LIBRARY})

    set(SNODEC_NET_INCLUDES ${SNODEC_LOGGER_INCLUDE} ${SNODEC_NET_INCLUDE})
    set(SNODEC_HTTP_INCLUDES ${SNODEC_NET_INCLUDES} ${SNODEC_UTILS_INCLUDE} ${SNODEC_HTTP_INCLUDE})
    set(SNODEC_EXPRESS_INCLUDES ${SNODEC_HTTP_INCLUDES} ${SNODEC_EXPRESS_INCLUDE})
endif(SNODEC_FOUND)
