...
if(NOT SNODEC_FOUND)
  ...
  find_library(SNODEC_LOGGER_LIBRARY logger HINTS ${SNODEC_LOGGER_ROOT_DIR}/lib)
  ...
  find_package_handle_standard_args(
    ...
    REQUIRED_VARS
      ...
      SNODEC_UTILS_H
    FAIL_MESSAGE
      "SnodeC not found: Define SNODEC_ROOT_DIR or set the environment variable SNODEC_ROOT_DIR to point to the directory where snode.c is installed."
  )
