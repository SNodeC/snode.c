...
namespace net::socket::ipv4::tcp::tls {
    ...
    class SocketClient : public net::socket::stream::tls::SocketClient<net::socket::ipv4::tcp::tls::Socket> {
    public:
        using net::socket::stream::tls::SocketClient<net::socket::ipv4::tcp::tls::Socket>::SocketClient;
    };
