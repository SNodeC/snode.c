...
#include "net/socket/bluetooth/l2cap/ClientSocket.h" // IWYU pragma: export
...
namespace net::socket::bluetooth::l2cap {
    ...
    using SocketClient = net::socket::stream::legacy::SocketClient<l2cap::Client, SocketContextFactoryT>;
