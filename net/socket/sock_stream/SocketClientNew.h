...
#ifndef NET_SOCKET_SOCK_STREAM_SOCKETCLIENTNEW_H
#define NET_SOCKET_SOCK_STREAM_SOCKETCLIENTNEW_H
...
namespace net::socket::stream {
    ...
    public:
        ...
        SocketClientNew(const std::function<void(SocketConnection* socketConnection)>& onConstruct,
        ...
        SocketClientNew() = delete;

        virtual ~SocketClientNew() = default;
...
#endif // NET_SOCKET_SOCK_STREAM_SOCKETCLIENTNEW_H
