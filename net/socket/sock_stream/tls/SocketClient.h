...
#ifndef NET_SOCKET_SOCK_STREAM_TLS_SOCKETCLIENT_H
#define NET_SOCKET_SOCK_STREAM_TLS_SOCKETCLIENT_H
...
namespace net::socket::stream::tls {
    ...
    class SocketClient : public socket::stream::SocketClient<tls::SocketConnection<SocketT>> {
    public:
        ...
        SocketClient(const std::function<void(SocketConnection* socketConnection)>& onConstruct,
            ...
            : socket::stream::SocketClient<SocketConnection>(
        ...
        void connect(const std::map<std::string, std::any>& options,
            ...
            if (sslErr != 0) {
                ...
                socket::stream::SocketClient<SocketConnection>::connect(
                    options,
...
#endif // NET_SOCKET_SOCK_STREAM_TLS_SOCKETCLIENT_H
