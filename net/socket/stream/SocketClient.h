...
namespace net::socket::stream {
    ...
    public:
        ...
        SocketClient(const std::function<void(const SocketAddress& localAddress, const SocketAddress& remoteAddress)>& onConstruct,
        ...
        connect(const SocketAddress& remoteAddress, const SocketAddress& bindAddress, const std::function<void(int err)>& onError) const {
            ...
            SocketConnector* socketConnector =
                new SocketConnector(onConstruct, onConnected, onDisconnect, onRead, onReadError, onWriteError, options);
