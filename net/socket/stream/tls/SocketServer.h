...
namespace net::socket::stream::tls {
    ...
    class SocketServer
        : public net::socket::stream::
              SocketServer<ServerSocketT, net::socket::stream::tls::SocketAcceptor<typename ServerSocketT::Socket>, SocketContextFactoryT> {
        using SocketServerBase = net::socket::stream::
            SocketServer<ServerSocketT, net::socket::stream::tls::SocketAcceptor<typename ServerSocketT::Socket>, SocketContextFactoryT>;
