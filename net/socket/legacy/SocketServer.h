...
namespace net::socket::legacy {
    ...
    class SocketServer : public net::socket::SocketServer<net::socket::legacy::SocketConnection> {
    public:
        using net::socket::SocketServer<net::socket::legacy::SocketConnection>::SocketServer;
