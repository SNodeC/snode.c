...
namespace net::socket::ip::tcp::ipv4::legacy {
    ...
    class SocketServer : public net::socket::ip::tcp::ipv4::SocketServer<net::socket::stream::legacy::SocketServer, SocketContextFactoryT> {
        using net::socket::ip::tcp::ipv4::SocketServer<net::socket::stream::legacy::SocketServer, SocketContextFactoryT>::SocketServer;
    };
