...
namespace net::socket::ip::tcp::ipv4::tls {
    ...
    class SocketClient : public stream::tls::SocketClient<SocketProtocolFactoryT, ipv4::Socket> {
        using stream::tls::SocketClient<SocketProtocolFactoryT, ipv4::Socket>::SocketClient;
    };
