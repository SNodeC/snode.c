...
namespace net::socket::ip::tcp::ipv6::tls {
    ...
    class SocketClient : public stream::tls::SocketClient<SocketProtocolFactoryT, ipv6::Socket> {
        using stream::tls::SocketClient<SocketProtocolFactoryT, ipv6::Socket>::SocketClient;
    };
