...
#ifndef NET_RFCOMM_STREAM_CLIENTSOCKET_H
#define NET_RFCOMM_STREAM_CLIENTSOCKET_H

#include "net/rfcomm/stream/Socket.h" // IWYU pragma: export
...
#endif // NET_RFCOMM_STREAM_CLIENTSOCKET_H
