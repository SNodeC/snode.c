...
| Typed wire request/result coverage | 58/87 | 66.7% | Stable client requests; includes typed initialization lifecycle support. |
| Typed notification/server-request coverage | 59/78 | 75.6% | Stable server notifications and server-initiated requests. |
