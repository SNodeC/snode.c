...
| Typed wire request/result coverage | 56/87 | 64.4% | Stable client requests; includes typed initialization lifecycle support. |
| Typed notification/server-request coverage | 56/78 | 71.8% | Stable server notifications and server-initiated requests. |
