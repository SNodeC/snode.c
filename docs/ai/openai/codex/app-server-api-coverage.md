...
| Typed wire request/result coverage | 55/87 | 63.2% | Stable client requests; includes typed initialization lifecycle support. |
| Typed notification/server-request coverage | 53/78 | 67.9% | Stable server notifications and server-initiated requests. |
| Typed item/delta coverage | 44/46 | 95.7% | Stable item discriminators plus delta/progress notification methods. |
