...
namespace web::ws {
    ...
    struct WSSubProtocolPlugin {
        WSSubProtocolPluginInterface* wSSubprotocolPluginInterface;
        void* handle;
    };
    ...
    protected:
        ...
        std::map<std::string, WSSubProtocolPlugin> serverSubprotocols;
        std::map<std::string, WSSubProtocolPlugin> clientSubprotocols;
    };
